...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2017 at 08:24 AM
...
(1, '2017-05-18 07:18:02', 2400, 1, 1, 1, 1);
...
INSERT INTO `purchasing_order_item` (`ItemID`, `ItemName`, `ItemDesc`, `Quantity`, `UnitPrice`, `PO_ID`) VALUES
(1, 'nike', NULL, 5, 5, 1),
(2, 'nike 1', NULL, 5, 25, 1),
(3, 'nike 2', NULL, 25, 90, 1);
...
--
ALTER TABLE `purchasing_order`
  MODIFY `PurchaseID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
